...
const btns = ({ btnNumClickHandler, allClear, operatorClickHandler, equallyClickHandler, btnDotClickHandler, contentClickHandler }) => {
    return (
        <div className="btns">
            <div className="btn ac bg-grey" onClick={allClear}>AC</div>
            <div className="btn plus-minus bg-grey" onClick={() => { contentClickHandler("+/-") }}>+/-</div>
            <div className="btn percent bg-grey" onClick={() => { contentClickHandler("%") }}>%</div>
